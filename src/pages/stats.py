...
from utils.player_viz import passe,shot,pass_cross,transition, persure_juego, pressure_heatmap,mistake,defensive_actions,passnetwork,assists,player
...
if teams_choice:
    ...
    text = "This table presents details of the matches played by the selected team"
...
if match_choice:
    ...
    text="Please select a match from 'Match' and the event type you would like to display"
    st.markdown(text, unsafe_allow_html=True)
